...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Authorization_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 56, 12)
    ...
    "Authorization\0toGame\0\0toGameClicked\0"
    "newPlayer\0addPlayer\0deletePlayer"
};
...
void Authorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toGame((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->toGameClicked(); break;
        case 2: _t->newPlayer(); break;
        case 3: _t->addPlayer(); break;
        case 4: _t->deletePlayer(); break;
        default: ;
        }
        ...
        {
            typedef void (Authorization::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Authorization::toGame)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Authorization::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Authorization.data,
      qt_meta_data_Authorization,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Authorization.stringdata))
...
// SIGNAL 0
void Authorization::toGame(QString _t1)
{
