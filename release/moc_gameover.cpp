...
QT_MOC_LITERAL(5, 44, 13)
    ...
    "GameOver\0toNewGame\0\0toAuth\0toNewGameClicked\0"
    "toAuthClicked"
};
...
void GameOver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toNewGame(); break;
        case 1: _t->toAuth(); break;
        case 2: _t->toNewGameClicked(); break;
        case 3: _t->toAuthClicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOver::toNewGame)) {
                *result = 0;
            }
        }
        {
            typedef void (GameOver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOver::toAuth)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void GameOver::toNewGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void GameOver::toAuth()
{
